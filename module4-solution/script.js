...
for ( i= 0 ; i < helloSpeakerGreeter.names.length; i++ ) {
  ...
  // name in the loop.
  if (firstLetter === 'J'/'j') {
    byeSpeakerGreeter.speakGoodBye(byeSpeakerGreeter.names[names]);
  } else {
    helloSpeakerGreeter.speakHello(helloSpeakerGreeter.names[names]);
  }
}
})(window);